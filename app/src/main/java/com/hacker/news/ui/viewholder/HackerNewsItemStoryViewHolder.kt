...
import kotlinx.android.synthetic.main.list_item_hacker_news_story.view.*
import java.text.NumberFormat
import java.util.*

class HackerNewsItemStoryViewHolder private constructor(
    itemView: View,
    ...
    companion object {
        fun create(
            ...
            HackerNewsItemStoryViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.list_item_hacker_news_story, parent, false),
                onClickAction
            )
    }
